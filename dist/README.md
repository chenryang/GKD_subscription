...
|QQ|21|<li>开屏广告<li>局部广告<li>分段广告<li>功能类-登录授权<li>功能类-自动勾选原图<li>功能类-自动点击查看原图<li>开屏广告-QQ小程序开屏广告<li>更新提示<li>更新提示-消息页面-顶部<li>局部广告-聊天页面广告<li>功能类-自动领取群聊红包<li>功能类-申请入群后自动点击右上角关闭<li>功能类-授权登录时关闭获取QQ好友关系<li>其他-联系人页面-顶部可能认识的人推荐<li>功能类-自动解锁 Windows QQ<li>功能类-关闭体验模式提醒<li>功能类-自动跳转第三方应用<li>功能类-不看或隐藏[官方Qzone]的动态<li>分段广告-QQ空间空友爱看<li>分段广告-空友爱看内的广告<li>局部广告-空间相册内广告|
...
|滔滔对讲|1|<li>开屏广告|
|淘宝|17|<li>开屏广告<li>全屏广告-弹窗广告<li>局部广告-横幅广告<li>局部广告-悬浮广告<li>权限提示-通知权限<li>功能类-各级页面添加到首页弹窗<li>更新提示<li>功能类-关闭小额免密支付<li>功能类-将小组件添加到手机桌面<li>权限提示-悬浮窗权限<li>全屏广告-花呗推荐弹窗<li>局部广告-商品详情页直播悬浮窗<li>功能类-登录授权<li>全屏广告-支付后的推荐弹窗<li>功能类-自动隐藏搜索页[猜你想搜][热榜]<li>功能类-付款前邀开通先用后付<li>功能类-自动退出竖屏模式|
